...
export default function Header (props) {
  ...
  //     <li key={button}>
  //       <button name={button.replace(/ /g,'')} onClick={props.handleClick} className="rounded-md block py-3 px-4 hover:bg-ncvColor-orange bg-ncvColor-orange">
  //         {button}
  //       </button>
  //     </li>
  // );
        ...
        >
          ...
          <ul className="flex flex-col lg:flex-row lg:space-x-10 text-center lg:text-left font-semibold text-xl">
            {navbarButtons.map((button) => 
              <li key={button}>
                <button name={button.replace(/ /g,'')} onClick={props.handleClick} className="rounded-md block py-3 px-4 hover:bg-ncvColor-orange bg-ncvColor-blue">
                  {button}
                </button>
              </li>)}
          </ul>
